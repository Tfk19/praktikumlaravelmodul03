                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-github"></i><small class="ms-2d-md-none">Github</i></small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-twitter"></i><small class="ms-2d-md-none">Twitter</i></small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-slack"></i><small class="ms-2d-md-none">Slack</i></small>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                           <!-- Dropdown -->
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <small><i class="bi-moon-stars-fill"></i>Dark</small></button></li>
                                                        <li><button class="dropdown-item" type="button">
